  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <ToolbarItem full={true} propKey="fontFamily" type="radio" label="Font Family">
          <ToolbarRadio value="Arial, sans-serif" label="Arial" />
          <ToolbarRadio value="Courier New, monospace" label="Courier New" />
          <ToolbarRadio value="Georgia, serif" label="Times New Roman" />
          <ToolbarRadio value="Verdana, sans-seriff" label="Verdana" />
          <ToolbarRadio value="Allura, cursive" label="Allura" />
          <ToolbarRadio value="Dancing Script, cursive" label="Dancing Script" />
        </ToolbarItem>
      </ToolbarSection>
      <ToolbarSection
        title="Margin"
